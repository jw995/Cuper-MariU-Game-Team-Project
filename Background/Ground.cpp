...
void Texture::init(void)
{
	...
	png[11].Decode("shoot.png");
	png[12].Decode("soji1.png");
	png[13].Decode("soji2.png");
}
...
void Texture::set(void)
{
	...
	set_texture(texId[11], png[11]);
	set_texture(texId[12], png[12]);
	set_texture(texId[13], png[13]);
}
